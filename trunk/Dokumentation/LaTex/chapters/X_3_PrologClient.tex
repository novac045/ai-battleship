...
\subsubsection{Initialisierungsmodul} \label{sec:initModule}
	...
	\todoin{Bogi - Schreib bitte erstmal verständliche Sätze ;)\newline Gesoffen? ;-D das ist super verständlich!! (Bin nochmal drübergegangen)}
	...
	\begin{figure}[H] % (fold)
		\centering
		\includegraphics[width=.9\textwidth]{images/fillWithShips.eps}
...
\todoin{Bogi - ich glaub das 'normalerweise' aus dem vorherigen satz gilt jetzt nicht mehr oder? entweder im Standardcode ändern oder hier im text - was denst du?\newline ACK! Text hier angepasst!}
